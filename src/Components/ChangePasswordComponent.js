...
<div className="page">
        ...
        <div class="col-sm-8 text-center signup" >
          ...
          <label >User Name&nbsp;</label>
            ...
            //                                 <td>
            //                                     <input type="text" placeholder="User Name" name="adminUserName" value={this.state.adminUserName} onChange={this.handleChange} />
            ...
            //                                 <td>
            //                                     <input type="Password" placeholder="Password" name="adminPassword" value={this.state.adminPassword} onChange={this.handleChange} />
            //                                     {/* <div className="errorMsg">{this.state.errors.adminPassword}</div> */}
            //                                 </td>
            //                             </tr>

                                      
            //                             <button className="btn btn-success" onClick={this.updateAdminPassword} >Update</button>
